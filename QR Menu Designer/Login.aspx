            ...
            <div class="bs-example">
                <div class="l-innerdiv">
                    ...
                    <div class="form-group" style="height: 12vh">
                        ...
                        <asp:RegularExpressionValidator ID="revPassword" runat="server" Display="Dynamic" ValidationGroup="login" ErrorMessage="Minimum password length is 6 characters" ForeColor="Red" Font-Size="Small" ValidationExpression=".{6}.*" ControlToValidate="txtPassword" />
                    </div>
                    <br />
