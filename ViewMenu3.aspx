...
<head runat="server">
    ...
    <style>
        .r-form {
            ...
            display: flex;
            flex-wrap: wrap;
            background-image: url('/images/menubg7.jpg');
                    ...
                    <asp:Repeater ID="rptCategory" runat="server" OnItemDataBound="rptCategory_ItemDataBound">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Repeater ID="rptItem" runat="server">
                                <ItemTemplate>
                                    <tr class="vm-tr-1">
                                        <td rowspan="2"><asp:Image ID="imgItem" CssClass="vm-img" ImageUrl='<%# PicturePath(sPath = "" + Eval("ItemImage") + "")%>' runat="server" /></td>
                            ...
                            <asp:Repeater ID="rptItemWithoutImg" runat="server">
                                <ItemTemplate>
                                    <tr class="vm-tr-1">
                                        <td colspan="2" class="vm-td-1 vm-td-alt text-center"><asp:Label ID="Label1" CssClass="vm-menu-content" runat="server" Text='<%#Eval("ItemName") %>'></asp:Label></td>
                                    </tr>
                                    <tr class="vm-tr-2">
                                        <td colspan="2" class="vm-td-2 vm-td-alt text-center"><asp:Label ID="Label2" CssClass="vm-menu-content" runat="server" Text='<%#Eval("Price", "{0:C2}") %>'></asp:Label></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ItemTemplate>
