    ...
    <form id="form1" runat="server">
        ...
        <div class="r-modal-errMsg" runat="server" id="modalSuccess">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTitle2" runat="server">Success</h5>
                    </div>
                    <div class="modal-body">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var toggleModalSuccess = document.getElementById('lblSuccessMsg').innerText;
        if (toggleModal) {
            $("#modalErrMsg").fadeIn();
            $("#modalBlur").fadeIn();
        }
        if (toggleModalSuccess) {
            $("#modalSuccess").fadeIn();
            $("#modalBlur").fadeIn();
        }
    });
